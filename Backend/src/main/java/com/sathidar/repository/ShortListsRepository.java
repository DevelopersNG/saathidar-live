...
public interface ShortListsRepository extends JpaRepository<ShortListsModel, Integer>{
	...
	Object addToShortListMember(String shortlist_from_id, String shortlist_to_id, String shortlist_status);
	...
	Object removeToShortListMember(String shortlist_from_id, String shortlist_to_id, String shortlist_status);
