...
//
//			@Override
//			public JSONArray getKycPhotos(String kyc_id) {
...
//			}
			...
			@Override
			public int rejectKYCPhoto(AdminKycModel adminKycModel) {
				return adminKycRepository.rejectKYCPhoto(adminKycModel.getImage_id());
			}

			@Override
			public int approveKYCPhoto(AdminKycModel adminKycModel) {
				return adminKycRepository.approveKYCPhoto(adminKycModel.getImage_id());
			}	
		}	
