...
import { Membersearch } from '../../model/membersearch.model';
...
export class MembersearchComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.SearchmemberService.getCountryName()
      .subscribe(
        results => {
    ...
    this.SearchmemberService.getAllStateName()
      .subscribe(
        results => {
    ...
    this.SearchmemberService.getAllCityName()
      .subscribe(
        results => {
    ...
    this.SearchmemberService.getReligionName()
      .subscribe(
        results => {
    ...
    this.SearchmemberService.getAllCastName()
      .subscribe(
        results => {
    ...
    this.SearchmemberService.getSearchMembersDetails(this.member_id)
      .subscribe(
        results => {
  ...
  callSearchMembers() {
    ...
    this.SearchmemberService.updateSearchMembersDetails(data, this.member_id)
      .subscribe(
        results => {
          // $(".overlay").hide();
          // this.dropdownListCity = results;
  ...
  getMemberDetailsByProfileID(){
    ...
    if(val.indexOf("MSD") !== -1 || val.indexOf("FSD") !== -1){
      ...
      this.SearchmemberService.checkProfileIDIsAvailable(val)
      .subscribe(
        results => {
